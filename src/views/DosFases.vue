<template>
  <div>
    ...
    <div class="configuracion">
      ...
      <label for="tipo-optimizacion">
        Tipo de Optimización:
        <select id="tipo-optimizacion" v-model="tipoOptimizacion">
    ...
    <div v-if="mostrarFormulario" class="formulario">
      ...
      <div class="seccion">
        ...
        <div class="ecuacion">
          {{ tipoOptimizacion === "max" ? "Maximizar Z =" : "Minimizar Z =" }}
      ...
      <!-- Botón Resolver -->
      <button @click="resolverDosFases">Resolver</button>
    </div>
    ...
    <div v-if="resultado" class="resultado">
      ...
      <h3>Iteraciones (Fase 1)</h3>
      <div v-for="(tabla, index) in resultado.iteraciones_fase1" :key="'fase1-' + index">
        <h4>Fase 1 - Iteración {{ index + 1 }}</h4>
      ...
      <h3>Iteraciones (Fase 2)</h3>
      <div v-for="(tabla, index) in resultado.iteraciones_fase2" :key="'fase2-' + index">
        <h4>Fase 2 - Iteración {{ index + 1 }}</h4>
        <table border="1" cellpadding="5">
          <thead>
            <tr>
              <th>Base</th>
